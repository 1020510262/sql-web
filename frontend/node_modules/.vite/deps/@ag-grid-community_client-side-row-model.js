...
var ClientSideNodeManager = class {
  ...
  updateRowOrderFromRowData(rowData) {
    ...
    const rowsLength = (rows == null ? void 0 : rows.length) ?? 0;
  ...
  sanitizeAddIndex(addIndex) {
    var _a;
    const allChildrenCount = ((_a = this.rootNode.allLeafChildren) == null ? void 0 : _a.length) ?? 0;
  ...
  executeRemove(rowDataTran, { rowNodeTransaction }, nodesToUnselect) {
    ...
    this.rootNode.allLeafChildren = ((_a = this.rootNode.allLeafChildren) == null ? void 0 : _a.filter((rowNode) => !rowIdsRemoved[rowNode.id])) ?? null;
    (_b = this.rootNode.allLeafChildren) == null ? void 0 : _b.forEach((node, idx) => {
  ...
  lookupRowNode(data) {
    ...
    if (getRowIdFunc) {
      ...
      rowNode = (_a = this.rootNode.allLeafChildren) == null ? void 0 : _a.find((node) => node.data === data);
      if (!rowNode) {
...
var ClientSideRowModel = class extends BeanStub {
  ...
  executeBatchUpdateRowData() {
    ...
    (_a = this.rowDataTransactionBatch) == null ? void 0 : _a.forEach((tranItem) => {
...
function refreshClientSideRowModel(beans, step) {
  var _a, _b;
  (_b = (_a = beans.rowModelHelperService) == null ? void 0 : _a.getClientSideRowModel()) == null ? void 0 : _b.refreshModel(step);
}
function isRowDataEmpty(beans) {
  var _a, _b;
  return ((_b = (_a = beans.rowModelHelperService) == null ? void 0 : _a.getClientSideRowModel()) == null ? void 0 : _b.isEmpty()) ?? true;
}
function forEachLeafNode(beans, callback) {
  var _a, _b;
  (_b = (_a = beans.rowModelHelperService) == null ? void 0 : _a.getClientSideRowModel()) == null ? void 0 : _b.forEachLeafNode(callback);
}
function forEachNodeAfterFilter(beans, callback) {
  var _a, _b;
  (_b = (_a = beans.rowModelHelperService) == null ? void 0 : _a.getClientSideRowModel()) == null ? void 0 : _b.forEachNodeAfterFilter(callback);
}
function forEachNodeAfterFilterAndSort(beans, callback) {
  var _a, _b;
  (_b = (_a = beans.rowModelHelperService) == null ? void 0 : _a.getClientSideRowModel()) == null ? void 0 : _b.forEachNodeAfterFilterAndSort(callback);
}
function resetRowHeights(beans) {
  ...
  (_b = (_a = beans.rowModelHelperService) == null ? void 0 : _a.getClientSideRowModel()) == null ? void 0 : _b.resetRowHeights();
}
function applyTransaction(beans, rowDataTransaction) {
  return beans.frameworkOverrides.wrapIncoming(
    () => {
      var _a, _b;
      return (_b = (_a = beans.rowModelHelperService) == null ? void 0 : _a.getClientSideRowModel()) == null ? void 0 : _b.updateRowData(rowDataTransaction);
    }
  );
}
function applyTransactionAsync(beans, rowDataTransaction, callback) {
  beans.frameworkOverrides.wrapIncoming(
    () => {
      var _a, _b;
      return (_b = (_a = beans.rowModelHelperService) == null ? void 0 : _a.getClientSideRowModel()) == null ? void 0 : _b.batchUpdateRowData(rowDataTransaction, callback);
    }
  );
}
function flushAsyncTransactions(beans) {
  beans.frameworkOverrides.wrapIncoming(
    () => {
      var _a, _b;
      return (_b = (_a = beans.rowModelHelperService) == null ? void 0 : _a.getClientSideRowModel()) == null ? void 0 : _b.flushAsyncTransactions();
    }
  );
}
...
var FilterStage = class extends BeanStub {
  ...
  filter(changedPath) {
    var _a;
    const filterActive = !!((_a = this.filterManager) == null ? void 0 : _a.isChildFilterPresent());
...
var SortService = class extends BeanStub {
  ...
  sort(sortOptions, sortActive, useDeltaSort, rowNodeTransactions, changedPath, sortContainsGroupColumns) {
    ...
    const callback = (rowNode) => {
      ...
      if (skipSortingGroups) {
        const nextGroup = (_a = this.funcColsService.getRowGroupColumns()) == null ? void 0 : _a[rowNode.level + 1];
  ...
  pullDownGroupDataForHideOpenParents(rowNodes, clearOperation) {
    ...
    rowNodes.forEach((childRowNode) => {
      var _a;
      const groupDisplayCols = ((_a = this.showRowGroupColsService) == null ? void 0 : _a.getShowRowGroupCols()) ?? [];
